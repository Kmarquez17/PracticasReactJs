...
const jwtCheck = jwt({
  secret: jwks.expressJwtSecret({
    ...
    jwksUri: "https://dev-5v8vvm9r.auth0.com/.well-known/jwks.json"
  }),
  audience: "http://productos",
  issuer: "https://dev-5v8vvm9r.auth0.com/",
  algorithms: ["RS256"]
});

// app.use(jwtCheck);

//revisamos y validamos los scope
const cheksScopes = jwtAuthz(['read:productos'])

app.get("/productos", jwtCheck, cheksScopes, (req, res) => {
  let productos = [
    {
      id: 0,
      nombre: "HTML5",
